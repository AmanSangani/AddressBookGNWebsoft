...
{ 
    ...
    private void Search(int PageNo)
    {
        ...
        DataTable dt = balMST_ReceiptType.SelectPage(Offset, PageRecordSize, out TotalRecords ,  ReceiptTypeName, PrintName, HospitalID);
	...
	if (ViewState["CurrentPage"] != null)
        ...
        MST_ReceiptTypeBAL balMST_ReceiptType = new MST_ReceiptTypeBAL();
        DataTable dtMST_ReceiptType = balMST_ReceiptType.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord ,  ReceiptTypeName,  PrintName,  HospitalID);

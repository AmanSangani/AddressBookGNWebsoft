<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="MST_ReceiptTypeList.aspx.cs" Inherits="AdminPanel_MST_ReceiptType_MST_ReceiptTypeList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
	<asp:Label ID="lblPageHeader_XXXXX" runat="server" Text="Receipt Type"></asp:Label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphBreadcrumb" runat="Server">
    ...
    <li class="active">
        <asp:Label ID="lblBreadCrumbLast" runat="server" Text="ReceiptType"></asp:Label>
    </li>
</asp:Content>
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group">
											...
											<asp:TextBox ID="txtReceiptTypeName" CssClass="First form-control" runat="server"  PlaceHolder="Enter Receipt Type Name"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                 <div>
									<asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Master/MST_ReceiptType/MST_ReceiptTypeAddEdit.aspx" runat="server"></asp:HyperLink>
                                ...
                                <div class="col-md-12">
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th><asp:Label ID="lbhReceiptTypeName" runat="server" Text="Receipt Type Name"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhPrintName" runat="server" Text="Print Name"></asp:Label>
                                                    </th>
                                                    <th><asp:Label ID="lbhIsDefault" runat="server" Text="Is Default"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                            <asp:HyperLink ID="hlViewReceiptTypeID" NavigateUrl='<%# "~/AdminPanel/Master/MST_ReceiptType/MST_ReceiptTypeView.aspx?ReceiptTypeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("ReceiptTypeID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("ReceiptTypeName") %></asp:HyperLink>
                                                            </td>
                                                            <td>
                                                            	<%#Eval("PrintName") %>
                                                            </td>
                                                            <td>
                                                              <asp:Label ID="lblIsDefault" runat="server" Text=' <%#Eval("IsDefault") %>' />
                                                            </td>
                                                            <td>
                                                            	<%#Eval("Hospital") %>
                                                            </td>
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Master/MST_ReceiptType/MST_ReceiptTypeView.aspx?ReceiptTypeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("ReceiptTypeID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
								<asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Master/MST_ReceiptType/MST_ReceiptTypeAddEdit.aspx?ReceiptTypeID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("ReceiptTypeID").ToString()) %>' runat="server"></asp:HyperLink>
                                                                <asp:LinkButton ID="lbtnDelete" runat="server"
                                                                    SkinID="Delete"
                                                                    OnClientClick="javascript:return confirm('Are you sure you want to delete record ? ');"
                                                                    CommandName="DeleteRecord"
                                                                    CommandArgument='<%#Eval("ReceiptTypeID") %>'>
                                                                </asp:LinkButton>
                                                            </td>
                                                        </tr>
                                                        <%-- END Table Rows --%>
